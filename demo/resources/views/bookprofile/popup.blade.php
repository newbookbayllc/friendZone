...
<div class="comment-div popup">
  ...
  @stop
<div id="basic_background" class="popup_background" style="opacity: 0.5; visibility: visible; position: fixed; top: 0px; right: 0px; bottom: 0px; left: 0px; z-index: 100000; background-color: black;"></div>
<div id="basic_wrapper" class="popup_wrapper popup_wrapper_visible" style="opacity: 1; visibility: visible; position: fixed; overflow: auto; z-index: 100001; width: 100%; height: 100%; top: 0px; left: 0px; text-align: center; display: block;">
  <div id="basic" class="well popup_content" style="max-width: 95%;padding:10px; opacity: 1; visibility: visible; display: inline-block; outline: none; text-align: left; position: relative; vertical-align: middle;" data-popup-initialized="true" aria-hidden="false" role="dialog" aria-labelledby="open_80629571" tabindex="-1">
    <table class="popup-details">
      <tr>
        <td><input type="radio" name="option" /></td>
        <td align="center">Buy Next Chapters only</td>
        <td><p>5 Banas <img src="{{ URL::asset('public/img/numbering.png') }}" /></p></td>
      </tr>
      <tr>
        <td><input type="radio" name="option" /></td>
        <td align="center">Buy all chapters</td>
        <td><p>500 Banas <img src="{{ URL::asset('public/img/numbering2.png') }}" /></p></td>
      </tr>
      <tr>
        <td><input type="radio" name="option" checked="checked" /></td>
        <td align="center">Buy all chapters plus physical books</td>
        <td><p><span class="strikethrough"><span class="black">650 Banas</span><img src="{{ URL::asset('public/img/numbering3.png') }}" /></span></p>
          <p>500 Banas</p></td>
      </tr>
    </table>
    <div class="popup-buttons">
      <ul>
        <li class="btn btn1"> Confirm </li>
        <li class="btn btn2"> Cancel </li>
      </ul>
    </div>
  </div>
...
<script>
	$(document).ready(function(e) {
		$('.btn2').on('click',function(){
			$('#basic_wrapper,.popup_background').fadeOut(1000);
		});
