...
<!-- <link rel="stylesheet" href="{{ URL::asset('frienZoneCss/css/bootstrap.min.css') }}" />
<script src="{{ URL::asset('frienZoneCss/js/jquery-1.11.2.min.js') }}"></script>
<link rel="stylesheet" href="{{ URL::asset('frienZoneCss/css/friend.css') }}" /> -->
...
<body>
   <div class="main-container gift-tab1">
  		<div class="container">
			<div class="row">
                ...
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 content">
                        ...
                        <div class="row icons">
                        	<div class="col-lg-3 col-md-3 col-sm-3 ">
                            	<a href="#"><img src="{{ URL::asset('friendZoneCss/images/block1.png') }}" class="img-responsive" /></a>
                                <p>礼物1</p>
                                <p>礼物说明文字</p>
